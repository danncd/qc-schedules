...
export default function InstructorIDClient({ instructorName, instructorData }: Props) {
    ...
    return (
        <main className="min-h-[calc(100vh-4rem)]">
            ...
            <div className={`p-4 border ${overallGpaStyles.border} rounded-lg mb-4 shadow-md dark:shadow-none`}>
                <div className={`${manrope.className} flex flex-row justify-between items-center`}>
                    <h2 className="font-bold text-md mb-2">Summary</h2>
                    <span
                        className={`font-extrabold text-lg px-2.5! py-0.5! rounded ${overallGpaStyles.bg} text-white shadow-sm`}
                    >
                ...
                <div className="flex flex-row gap-2 mt-1">
                    <div className="bg-gray-400/90 dark:bg-gray-300 w-1 stretch rounded-full my-0.5" />
